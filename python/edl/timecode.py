...
def timecode_from_frame(frame, fps=24):
    ...
    # :obj:`int` values are cast to :obj:`float` with ``Decimal``
...
class Timecode(object):
    ...
    def __sub__(self, right):
        """
        - operator override : Substract a timecode or a number of frames to this :class:`Timecode`
    ...
    def __rsub__(self, left):
        """
        - operator override : Substract a number of frames to this :class:`Timecode`, with the
        timecode on the left of the ``-`` operator.
